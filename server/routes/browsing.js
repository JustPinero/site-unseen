				...
				if (reports.rows.length === 0) {
					...
					const sendReportMail = (username, id, sender_id) => {
						...
						var mailOptions = {
							...
							subject: 'Site Unseen user reported as fake account',
							html: `<h1>Hello!</h1>
								<p>Bad news, admin. Someone on Site Unseen just reported a user as a fake account.</p>
