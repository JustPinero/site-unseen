...
// 					to: useremail,
// 					subject: 'Site Unseen account confirmation',
// 					html: `<h1>Welcome</h1><p>You have just signed up for Site Unseen, well done!</p>
// 						<p>CONFIRM!</p>
// 						<a href="http://localhost:3000/confirm/${username}/${code}">Click here</a>
// 						<p>Love, Site Unseen Mail</p>`
// 				};
